window.addEventListener("DOMContentLoaded", () => {
  ...
  const modalTrigger = querySelectorAll("[data-modal]"),
...
class MenuCard {
  ...
  render() {
    ...
    element.innerHTML = `
    <im src=${this.src} alt=${this.alt} />
    <h3 class="meu__item-subtitle">${this.title}</h3>
    <div class="menu__item-descr">${this.descr}</div>
    <div class="menu__item-divider"></div>
    <div class="menu__item-price">
      <div class="menu__item-cost">Price:</div>
      <div class="menu__item-totla"><span>${this.price}</span> uzs/month</div>
    </div>
    `
